...
if [[ $(whoami) == "jonas" ]]; then
  ...
  mkln "nvim-config" "$HOME/.config/nvim" "$HOME/.config/nvim"
  # mkln "autostart"                                    "$HOME/.config/autostart"
  mkln "scripts" "$HOME/scripts" "$HOME/scripts"
  mkln "IoTuring" "$HOME/.config/IoTuring" "$HOME/.config/IoTuring"
  ...
  mkln "waybar" "$HOME/.config/waybar" "$HOME/.config/waybar"
  mkln "scroll" "$HOME/.config/scroll" "$HOME/.config/scroll"
  mkln "sway" "$HOME/.config/sway" "$HOME/.config/sway"
